package com.donatarian.parkingsitestask.presenters

import android.graphics.Color
import android.os.AsyncTask
import android.os.Handler
import android.util.Log
import com.donatarian.parkingsitestask.App
...
class ParkingPresenter(var view: ParkingContract.View) : ParkingContract.Presenter {
    ...
    //Inner class used to get the polyline data from API
    inner class GetDirection(val url: String) : AsyncTask<Void, Void, List<List<LatLng>>>() {
        ...
        override fun onPostExecute(result: List<List<LatLng>>) {
            ...
            view.setPolyline(lineoption)
        }

        //polyline comes encoded from google, this method decodes it
